		...
		<div class="blog">
			...
			<div class="blog-post-wrap">
				...
				<div class="blog-post">
					...
					<?php } else {  // for certain mathematics posts with NO featured image?>
					<a href="<?php the_permalink(); ?>"><img src="<?php the_field('problem'); ?>" alt="Thumbnail Image" class="post-featured-image"></a>
					<?php
					}
					?>
